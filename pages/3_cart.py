...
coverage_report, ranking_report, classification_report, rating_report= utils.master_m(df_loja_rec,'https://github.com/vpbatista85/epd-final/tree/test/metrics')
