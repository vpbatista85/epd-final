...
coverage_report, ranking_report, classification_report, rating_report= utils.master_m(st.session_state.df_loja_af,'https://github.com/vpbatista85/epd-final/tree/test/',st.session_state.store)

if 'coverage_report'not in st.session_state:
    st.session_state.coverage_report=coverage_report

if 'ranking_report'not in st.session_state:
    st.session_state.ranking_report=ranking_report
